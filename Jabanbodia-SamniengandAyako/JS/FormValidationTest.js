...
function validateSelect(){
    ...
    var input = document.form.important.value;
   // alert(input);
    if(input=="null"){

        document.getElementById("selectError").style.color="red";
        document.getElementById("selectError").style.fontSize="20px";
        ...
        document.getElementById("selectError").style.fontSize="20px";
        document.getElementById("selectError").innerHTML="Valid";
        return true;
    ...
    if(validateFname()==true && validateLname()==true &&validatePhone()==true && validateEmail()==true && validateComment()==true && validateDdate()==true && validateAdate()==true &&validateSelect()==true ){
      //  alert("success");
